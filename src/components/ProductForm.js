...
const ProductForm = ({ handleHide, handleFetch }) => {
     ...
     const onSubmit = async (data) => {
          ...
          await api.post("/products", merged);
     ...
     <div className="w-full lg:w-9/12 bg-white p-8 mt-16 rounded-lg lg:rounded-l-none">
          ...
          <h4 className="block mb-5 text-xl text-gray-700">Add New Product</h4>
          ...
          <div className="text-left text-sm mt-3">
               <button type="submit" className='px-3 py-2 mr-1 bg-sky-500 rounded-md text-slate-50'>Add Product</button>
